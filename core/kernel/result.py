...
class Result(Generic[T, E]):
    ...
    @property
    def is_ok(self) -> bool:
        return self.error is None and self.bad_request_error is None and self.not_found_error is None

    @property
    def is_err(self) -> bool:
        return self.error is not None or self.bad_request_error is not None or self.not_found_error is not None
