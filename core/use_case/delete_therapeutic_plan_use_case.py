...
class DeleteTherapeuticPlanUseCase:
    ...
    async def execute(self, therapeutic_plan_id: int):
        try:
            ...
            await self.therapeutic_plan_repository.delete(therapeutic_plan)

            return Result.ok("Plano terapêutico deletado com sucesso")
        except Exception as e:
            return Result.error(f"Erro ao deletar plano terapêutico")
