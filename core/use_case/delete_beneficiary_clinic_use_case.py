...
class DeleteBeneficiaryClinicUseCase:
    ...
    async def execute(self, beneficiary_clinic_id: int):
        try:
            ...
            await self.beneficiary_clinic_repository.delete(beneficiary_clinic)

            return Result.ok("Relacionamento beneficiário-clínica deletado com sucesso")
        except Exception as e:
            return Result.error(f"Erro ao deletar relacionamento beneficiário-clínica")
