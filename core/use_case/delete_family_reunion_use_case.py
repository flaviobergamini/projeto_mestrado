...
class DeleteFamilyReunionUseCase:
    ...
    async def execute(self, family_reunion_id: int):
        try:
            ...
            await self.family_reunion_repository.delete(family_reunion)

            return Result.ok("Reunião familiar deletada com sucesso")
        except Exception as e:
            return Result.error(f"Erro ao deletar reunião familiar")
